...
CBITS0:     DB      $C0,$30,$0C,$03     ; set bits
CMASK0:     DB      $3F,$CF,$F3,$FC     ; clear mask
CBITS1:     DB      $C0,$30,$0C,$03     ; set bits
CMASK1:     DB      $3F,$CF,$F3,$FC     ; clear mask
CBITS2:     DB      $C0,$30,$0C,$03     ; set bits
CMASK2:     DB      $3F,$CF,$F3,$FC     ; clear mask
